...
class CustomTransform:
    def __init__(self, random_gray = 0.15, random_rotation = 0, random_flip = 0.1, is_train = True, is_padding_with_ratio = True):
    ...
    def __call__(self, image):
        ...
        # Noise augmentation 
        if np.random.uniform() < 0.4 and self.is_train: 
